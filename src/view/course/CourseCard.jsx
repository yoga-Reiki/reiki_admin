...
const CourseCard = ({ setIsEditingCard, setSelectedCourse, coursesData, setCoursesDelete }) => {
                    ...
                    >
                        {coursesData?.map((data, index) => (
                            ...
                            >
                                ...
                                <button onClick={() => setCoursesDelete(data)} className="absolute bottom-3 left-3 bg-white p-3 rounded-full border border-[#989898] hover:bg-gray-100">
                                ...
                                <div className="absolute flex flex-col justify-between top-3 right-3 bottom-3 w-[80%] sm:w-[75%] md:w-[56%] bg-white rounded-3xl px-6 py-4.5">
                                    ...
                                    <div className="flex items-end gap-2">
                                        ...
                                        <span className="text-lg text-[#EF4444] line-through">${data.priceOld}</span>
                                    </div>
                                </div>
                            </div>
                        ))}
