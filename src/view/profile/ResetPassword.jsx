                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={onChange}
                                            className={`w-full h-11 px-4 py-2.5 rounded-full text-[#525252] placeholder-[#525252] border-[1px] border-[#BDBDBD] focus:outline-none focus:ring-0 focus:border-[#EA7913]`}
